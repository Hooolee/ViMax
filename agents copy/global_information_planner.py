...
class GlobalInformationPlanner:
    ...
    async def merge_characters_across_scenes_in_event(
        ...
        log_agent_prompt(
            ...
            agent_name="GlobalInformationPlanner",
            ...
            metadata={"method": "merge_characters_across_scenes_in_event", "model": str(self.chat_model)}
        ...
        log_agent_prompt(
            ...
            metadata={"method": "merge_characters_across_scenes_in_event"}
    ...
    def merge_characters_to_existing_characters_in_novel(
        ...
        log_agent_prompt(
            ...
            metadata={"method": "merge_characters_to_existing_characters_in_novel", "model": str(self.chat_model)}
        ...
        log_agent_prompt(
            ...
            metadata={"method": "merge_characters_to_existing_characters_in_novel"}
