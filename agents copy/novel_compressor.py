...
class NovelCompressor:
    ...
    async def compress_single_novel_chunk(
        ...
        async with semaphore:
            ...
            log_agent_prompt(
                ...
                agent_name="NovelCompressor",

                prompt_type="system",

                prompt_content=messages[0].content,

                metadata={"method": "compress_single_novel_chunk", "model": str(self.chat_model)}
            ...
            log_agent_prompt(
                ...
                metadata={"method": "compress_single_novel_chunk"}
    ...
    def aggregate(
        ...
        log_agent_prompt(
            ...
            metadata={"method": "aggregate", "model": str(self.chat_model)}
