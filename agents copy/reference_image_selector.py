...
"""
        ...
        log_agent_prompt(
            ...
            agent_name="ReferenceImageSelector",
            ...
            metadata={"method": "generate_prompt_for_selected_images", "model": str(self.chat_model)}
        ...
        log_agent_prompt(
            ...
            metadata={"method": "generate_prompt_for_selected_images"}
    ...
    async def select_reference_images_and_generate_prompt(
        ...
        if len(filtered_image_path_and_text_pairs) >= 8:
            ...
            log_agent_prompt(
                ...
                metadata={"method": "select_reference_images_and_generate_prompt", "model": str(self.chat_model)}
            ...
            log_agent_prompt(
                ...
                metadata={"method": "select_reference_images_and_generate_prompt"}
